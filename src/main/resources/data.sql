...
(9, 'Tropical Breeze', 'Catamaran', 40.0, 10, 2018, 'Caribbean Tours'),
(10, 'Harbor Master', 'Fishing Boat', 35.0, 6, 2017, 'Coastal Fisheries'),
(11, 'Starlight', 'Sailboat', 42.0, 7, 2014, 'Seven Seas Sailing'),
(12, 'Neptune King', 'Motor Yacht', 65.0, 16, 2020, 'Royal Cruises'),
(13, 'Lightning Bolt', 'Speedboat', 22.0, 2, 2022, 'Speed Demons'),
(14, 'Coral Island', 'Catamaran', 38.5, 9, 2019, 'Island Paradise Tours'),
(15, 'Deep Catcher', 'Fishing Boat', 38.5, 7, 2018, 'Industrial Fishing'),
(16, 'Morning Glory', 'Sailboat', 41.0, 6, 2016, 'Wind Warriors Club'),
(17, 'Emerald Queen', 'Motor Yacht', 55.0, 11, 2017, 'Emerald Fleet'),
